...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/offline-audio-test', (req, res) => {
    import('path').then(path => {
      res.sendFile(path.join(__dirname, '../offline-audio-test.html'));
    });
  });

  app.get('/simple-test', (req, res) => {
    import('path').then(path => {
      res.sendFile(path.join(__dirname, '../simple-homepage-test.html'));
    });
  });
  
  // CRITICAL FIX: Removed ALL server module routes 
  // Let React routing handle /module/1 through /module/15
  // This fixes the white screen issue for modules 13-15
  
  /*
  COMMENTED OUT ALL MODULE ROUTES - React handles these now
...
<body>
  ...
  // END OF COMMENTED MODULE ROUTES - React handles /module/* routing
  */
  ...
  app.get("/api/version", (req, res) => {
    ...
    res.json({
      ...
      features: [
        'COMPLETE: All audio placeholders eliminated - no more console.log audio',
        'ENHANCED: Strict English-only audio system across all modules',
        'GUARANTEED: English-only audio offline with bulletproof filtering',
        'FIXED: Module 1 and Module 11 missing audio replaced with working system',
        'DEPLOYED: Force offline deployment system for all users worldwide',
        'ROBUST: VisualExamples component uses strictEnglishAudio system',
        'RESOLVED: All French audio issues completely eliminated'
      ],
      updateRequired: true,
      criticalUpdate: true,
      offlineCapable: true,
      ...
      message: 'CRITICAL UPDATE v3.0.3: Complete audio system overhaul! All placeholders eliminated, English-only audio guaranteed offline.'
    });
  });
  ...
  app.get("/api/manifest", (req, res) => {
    ...
    res.json({
      ...
      criticalUpdate: true,
      updateMessage: 'COMPLETE: All audio placeholders fixed! Enhanced offline deployment with guaranteed English-only audio.',
      modulesWorking: 15,
      offlineCapable: true,
  ...
  // CRITICAL FIX: Add missing API endpoints for modules 1-10
  
  // Module 1 API endpoint
  app.get('/api/modules/1', (req, res) => {
    res.json({
      id: 1,
      title: "Alphabet & Numbers",
      ...
      lessons: [
        {
          ...
          content: {
            introduction: "Welcome to Module 1! Today we will learn the English alphabet and numbers. Let us start with the 26 letters.",
            alphabet: [
              { letter: "A", emoji: "🅰️", pronunciation: "ay", french: "A", hausa: "A" },
              { letter: "B", emoji: "🅱️", pronunciation: "bee", french: "B", hausa: "B" },
              { letter: "C", emoji: "©️", pronunciation: "see", french: "C", hausa: "C" },
              { letter: "D", emoji: "🌟", pronunciation: "dee", french: "D", hausa: "D" },
              { letter: "E", emoji: "🌍", pronunciation: "ee", french: "E", hausa: "E" },
              { letter: "F", emoji: "🔥", pronunciation: "eff", french: "F", hausa: "F" },
              { letter: "G", emoji: "⚡", pronunciation: "gee", french: "G", hausa: "G" },
              { letter: "H", emoji: "🏠", pronunciation: "aych", french: "H", hausa: "H" },
              { letter: "I", emoji: "👁️", pronunciation: "eye", french: "I", hausa: "I" },
              { letter: "J", emoji: "😊", pronunciation: "jay", french: "J", hausa: "J" },
              { letter: "K", emoji: "🔑", pronunciation: "kay", french: "K", hausa: "K" },
              { letter: "L", emoji: "❤️", pronunciation: "ell", french: "L", hausa: "L" },
              { letter: "M", emoji: "🌙", pronunciation: "em", french: "M", hausa: "M" },
              { letter: "N", emoji: "🌎", pronunciation: "en", french: "N", hausa: "N" },
              { letter: "O", emoji: "⭕", pronunciation: "oh", french: "O", hausa: "O" },
              { letter: "P", emoji: "🎨", pronunciation: "pee", french: "P", hausa: "P" },
              { letter: "Q", emoji: "👑", pronunciation: "cue", french: "Q", hausa: "Q" },
              { letter: "R", emoji: "🌈", pronunciation: "are", french: "R", hausa: "R" },
              { letter: "S", emoji: "☀️", pronunciation: "ess", french: "S", hausa: "S" },
              { letter: "T", emoji: "🌳", pronunciation: "tee", french: "T", hausa: "T" },
              { letter: "U", emoji: "☂️", pronunciation: "you", french: "U", hausa: "U" },
              { letter: "V", emoji: "✌️", pronunciation: "vee", french: "V", hausa: "V" },
              { letter: "W", emoji: "🌊", pronunciation: "double-you", french: "W", hausa: "W" },
              { letter: "X", emoji: "❌", pronunciation: "ex", french: "X", hausa: "X" },
              { letter: "Y", emoji: "✨", pronunciation: "why", french: "Y", hausa: "Y" },
              { letter: "Z", emoji: "⚡", pronunciation: "zee", french: "Z", hausa: "Z" }
            ]
          }
        },
        {
          ...
          title: "Numbers 1-20",
          content: {
            introduction: "Now let us count from 1 to 20. Numbers help us count things.",
            numbers: [
              { number: 1, word: "One", emoji: "1️⃣", french: "Un", hausa: "Daya" },
              { number: 2, word: "Two", emoji: "2️⃣", french: "Deux", hausa: "Biyu" },
              { number: 3, word: "Three", emoji: "3️⃣", french: "Trois", hausa: "Uku" },
              { number: 4, word: "Four", emoji: "4️⃣", french: "Quatre", hausa: "Hudu" },
              { number: 5, word: "Five", emoji: "5️⃣", french: "Cinq", hausa: "Biyar" },
              { number: 6, word: "Six", emoji: "6️⃣", french: "Six", hausa: "Shida" },
              { number: 7, word: "Seven", emoji: "7️⃣", french: "Sept", hausa: "Bakwai" },
              { number: 8, word: "Eight", emoji: "8️⃣", french: "Huit", hausa: "Takwas" },
              { number: 9, word: "Nine", emoji: "9️⃣", french: "Neuf", hausa: "Tara" },
              { number: 10, word: "Ten", emoji: "🔟", french: "Dix", hausa: "Goma" },
              { number: 11, word: "Eleven", emoji: "1️⃣1️⃣", french: "Onze", hausa: "Goma sha daya" },
              { number: 12, word: "Twelve", emoji: "1️⃣2️⃣", french: "Douze", hausa: "Goma sha biyu" },
              { number: 13, word: "Thirteen", emoji: "1️⃣3️⃣", french: "Treize", hausa: "Goma sha uku" },
              { number: 14, word: "Fourteen", emoji: "1️⃣4️⃣", french: "Quatorze", hausa: "Goma sha hudu" },
              { number: 15, word: "Fifteen", emoji: "1️⃣5️⃣", french: "Quinze", hausa: "Goma sha biyar" },
              { number: 16, word: "Sixteen", emoji: "1️⃣6️⃣", french: "Seize", hausa: "Goma sha shida" },
              { number: 17, word: "Seventeen", emoji: "1️⃣7️⃣", french: "Dix-sept", hausa: "Goma sha bakwai" },
              { number: 18, word: "Eighteen", emoji: "1️⃣8️⃣", french: "Dix-huit", hausa: "Goma sha takwas" },
              { number: 19, word: "Nineteen", emoji: "1️⃣9️⃣", french: "Dix-neuf", hausa: "Goma sha tara" },
              { number: 20, word: "Twenty", emoji: "2️⃣0️⃣", french: "Vingt", hausa: "Ashirin" }
            ]
          }
        }
      ]
      ...
      lessons: [
        {
          ...
          content: {
            introduction: "Welcome to Module 2! Today we will learn greetings and how to introduce ourselves. Let us start with basic greetings.",
            greetings: [
              { greeting: "Good Morning", time: "morning", emoji: "🌅", french: "Bonjour", hausa: "Ina kwana", use: "Use in the morning (6 AM - 12 PM)" },
              { greeting: "Good Afternoon", time: "afternoon", emoji: "☀️", french: "Bon après-midi", hausa: "Ina wuni", use: "Use after 12 PM until 5 PM" },
              { greeting: "Good Evening", time: "evening", emoji: "🌆", french: "Bonsoir", hausa: "Ina yamma", use: "Use in the evening (5 PM onwards)" },
              { greeting: "Hello", time: "anytime", emoji: "👋", french: "Salut", hausa: "Sannu", use: "Use anytime - casual and friendly" },
              { greeting: "Hi", time: "anytime", emoji: "👋", french: "Salut", hausa: "Sannu", use: "Use anytime - very casual" }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn how to introduce ourselves and ask questions.",
            introductions: [
              { phrase: "My name is...", french: "Je m'appelle...", hausa: "Sunana...", example: "My name is Ahmed." },
              { phrase: "I am...", french: "Je suis...", hausa: "Ni...", example: "I am 10 years old." },
              { phrase: "I live in...", french: "J'habite à...", hausa: "Ina zaune a...", example: "I live in Maradi." },
              { phrase: "I am from...", french: "Je viens de...", hausa: "Na fito daga...", example: "I am from Niger." },
              { phrase: "How old are you?", french: "Quel âge as-tu?", hausa: "Nawa ne shekarunka?", example: "How old are you? I am 12 years old." },
              { phrase: "Where do you live?", french: "Où habites-tu?", hausa: "Ina kake zaune?", example: "Where do you live? I live in Niamey." }
            ]
          }
        }
      ]
  ...
  // Quick API endpoints for modules 3-10 (essential structure)
  app.get('/api/modules/3', (req, res) => {
    res.json({
      id: 3,
      ...
      lessons: [
        {
          ...
          title: "Family Members",
          content: {
            introduction: "Welcome to Module 3! Today we will learn about family members and pronouns. Let us start with family members.",
            family: [
              { member: "Father", emoji: "👨", french: "Père", hausa: "Uba", description: "Male parent - Dad" },
              { member: "Mother", emoji: "👩", french: "Mère", hausa: "Uwa", description: "Female parent - Mom" },
              { member: "Brother", emoji: "👦", french: "Frère", hausa: "Dan uwa", description: "Male sibling" },
              { member: "Sister", emoji: "👧", french: "Sœur", hausa: "Yar uwa", description: "Female sibling" },
              { member: "Grandfather", emoji: "👴", french: "Grand-père", hausa: "Kaka", description: "Father's or mother's father" },
              { member: "Grandmother", emoji: "👵", french: "Grand-mère", hausa: "Kaka", description: "Father's or mother's mother" }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn pronouns. I for myself. You for the person I talk to. He for a boy or man. She for a girl or woman. We for us together. They for other people.",
            pronouns: [
              { pronoun: "I", french: "Je", hausa: "Ni", usage: "for myself", example: "I am a student." },
              { pronoun: "You", french: "Tu/Vous", hausa: "Kai/Ke", usage: "for the person I'm talking to", example: "You are my friend." },
              { pronoun: "He", french: "Il", hausa: "Shi", usage: "for a boy or man", example: "He is my brother." },
              { pronoun: "She", french: "Elle", hausa: "Ita", usage: "for a girl or woman", example: "She is my sister." },
              { pronoun: "We", french: "Nous", hausa: "Mu", usage: "for us together", example: "We are students." },
              { pronoun: "They", french: "Ils/Elles", hausa: "Su", usage: "for other people", example: "They are my friends." }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/4', (req, res) => {
    res.json({
      id: 4,
      title: "Classroom, Colors & Shapes",
      description: "Learn classroom objects, basic colors, and simple shapes for describing the world around us.",
      lessons: [
        {
          id: 1,
          title: "Classroom Objects",
          content: {
            introduction: "Welcome to Module 4! Let us learn about things we see in the classroom every day.",
            objects: [
              { object: "Pen", emoji: "🖊️", french: "Stylo", hausa: "Alkalami", usage: "I write with a pen." },
              { object: "Book", emoji: "📚", french: "Livre", hausa: "Littafi", usage: "I read a book." },
              { object: "Chair", emoji: "🪑", french: "Chaise", hausa: "Kujera", usage: "I sit on a chair." },
              { object: "Table", emoji: "🪑", french: "Table", hausa: "Tebur", usage: "I put my book on the table." },
              { object: "Bag", emoji: "🎒", french: "Sac", hausa: "Jaka", usage: "I carry my books in a bag." }
            ]
          }
        },
        {
          ...
          title: "Colors & Shapes",
          content: {
            introduction: "Now let us learn colors and shapes to describe things around us.",
            colors: [
              { color: "Red", emoji: "🔴", french: "Rouge", hausa: "Ja", example: "The apple is red." },
              { color: "Blue", emoji: "🔵", french: "Bleu", hausa: "Shudi", example: "The sky is blue." },
              { color: "Yellow", emoji: "🟡", french: "Jaune", hausa: "Rawaya", example: "The sun is yellow." },
              { color: "Green", emoji: "🟢", french: "Vert", hausa: "Kore", example: "The grass is green." }
            ],
            shapes: [
              { shape: "Circle", emoji: "⭕", french: "Cercle", hausa: "Da'ira", example: "The ball is a circle." },
              { shape: "Square", emoji: "🟩", french: "Carré", hausa: "Murabba'i", example: "The window is a square." },
              { shape: "Triangle", emoji: "🔺", french: "Triangle", hausa: "Triangle", example: "The roof is a triangle." },
              { shape: "Rectangle", emoji: "🟪", french: "Rectangle", hausa: "Rectangle", example: "The door is a rectangle." }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/5', (req, res) => {
    res.json({
      id: 5,
      title: "Verbs & Daily Routines",
      description: "Learn action verbs and daily activities using simple present tense.",
      lessons: [
        {
          id: 1,
          title: "Action Verbs",
          content: {
            introduction: "Welcome to Module 5! Today we learn action words - verbs! These words tell us what people do.",
            verbs: [
              { verb: "Eat", emoji: "🍽️", french: "Manger", hausa: "Ci", example: "I eat breakfast every morning." },
              { verb: "Sleep", emoji: "😴", french: "Dormir", hausa: "Barci", example: "I sleep at night." },
              { verb: "Play", emoji: "⚽", french: "Jouer", hausa: "Wasa", example: "I play with my friends." },
              { verb: "Read", emoji: "📖", french: "Lire", hausa: "Karanta", example: "I read books every day." },
              { verb: "Write", emoji: "✍️", french: "Écrire", hausa: "Rubutu", example: "I write in my notebook." }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn about daily routines - things we do every day using simple present tense.",
            routines: [
              { routine: "I wake up at 6 AM", french: "Je me réveille à 6h", hausa: "Na farka da karfe 6", time: "Morning" },
              { routine: "I brush my teeth", french: "Je me brosse les dents", hausa: "Na goge hakora", time: "Morning" },
              { routine: "I go to school", french: "Je vais à l'école", hausa: "Na je makaranta", time: "Morning" },
              { routine: "I eat lunch", french: "Je déjeune", hausa: "Na ci abincin rana", time: "Afternoon" },
              { routine: "I do homework", french: "Je fais mes devoirs", hausa: "Na yi aikin gida", time: "Evening" },
              { routine: "I go to bed", french: "Je vais au lit", hausa: "Na je barci", time: "Night" }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/6', (req, res) => {
    res.json({
      id: 6,
      title: "Food, Animals & Plurals",
      description: "Learn about common foods and animals. Practice plural formation and express preferences.",
      lessons: [
        {
          id: 1,
          title: "Common Foods",
          content: {
            introduction: "Welcome to Module 6! Today we will learn about food and animals. Let us start with common foods we eat every day.",
            foods: [
              { food: "Bread", emoji: "🍞", french: "Pain", hausa: "Gurasa", example: "I eat bread for breakfast." },
              { food: "Rice", emoji: "🍚", french: "Riz", hausa: "Shinkafa", example: "We cook rice and eat it with sauce." },
              { food: "Milk", emoji: "🥛", french: "Lait", hausa: "Madara", example: "Milk makes us strong and healthy." },
              { food: "Banana", emoji: "🍌", french: "Banane", hausa: "Ayaba", example: "Bananas taste sweet and give us energy." }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn about animals we see around us in Niger and the world.",
            animals: [
              { animal: "Cow", emoji: "🐄", french: "Vache", hausa: "Saniya", example: "Cows give us milk and meat." },
              { animal: "Goat", emoji: "🐐", french: "Chèvre", hausa: "Akuya", example: "Goats give us milk and meat." },
              { animal: "Chicken", emoji: "🐓", french: "Poule", hausa: "Kaza", example: "Chickens give us eggs and meat." },
              { animal: "Dog", emoji: "🐕", french: "Chien", hausa: "Kare", example: "Dogs are our friends and protect our homes." }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/7', (req, res) => {
    res.json({
      id: 7,
      title: "Present Continuous & Abilities",
      description: "Learn actions happening now using -ing verbs and express abilities with can/can't.",
      lessons: [
        {
          id: 1,
          title: "Actions Happening Now",
          content: {
            introduction: "Welcome to Module 7! Today we learn about actions happening right now! We add -ing to verbs.",
            presentContinuous: [
              { base: "Play", continuous: "Playing", example: "I am playing football now.", french: "Je joue au football maintenant", hausa: "Ina wasa kwallon kafa yanzu" },
              { base: "Read", continuous: "Reading", example: "She is reading a book now.", french: "Elle lit un livre maintenant", hausa: "Tana karanta littafi yanzu" },
              { base: "Write", continuous: "Writing", example: "We are writing letters now.", french: "Nous écrivons des lettres maintenant", hausa: "Muna rubuta wasiƙu yanzu" },
              { base: "Eat", continuous: "Eating", example: "They are eating dinner now.", french: "Ils dînent maintenant", hausa: "Suna cin abincin dare yanzu" }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn about abilities - what we can do and what we cannot do using 'can' and 'can't'.",
            abilities: [
              { ability: "I can swim", french: "Je peux nager", hausa: "Ina iya iyo", type: "positive" },
              { ability: "I can't fly", french: "Je ne peux pas voler", hausa: "Ba zan iya tashi ba", type: "negative" },
              { ability: "Can you sing?", french: "Peux-tu chanter?", hausa: "Kana iya waƙa?", type: "question" },
              { ability: "She can dance", french: "Elle peut danser", hausa: "Tana iya rawa", type: "positive" }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/8', (req, res) => {
    res.json({
      id: 8,
      title: "Adjectives & Prepositions",
      description: "Learn descriptive words and position words to describe people, things, and locations.",
      lessons: [
        {
          id: 1,
          title: "Describing Words",
          content: {
            introduction: "Welcome to Module 8! Today we learn describing words - adjectives! These words tell us about people and things.",
            adjectives: [
              { adjective: "Big", opposite: "Small", emoji: "🐘", french: "Grand/Petit", hausa: "Babba/Ƙarami", example: "The elephant is big. The mouse is small." },
              { adjective: "Happy", opposite: "Sad", emoji: "😊", french: "Heureux/Triste", hausa: "Farin ciki/Baƙin ciki", example: "I am happy when I play. I am sad when I lose." },
              { adjective: "Hot", opposite: "Cold", emoji: "🔥", french: "Chaud/Froid", hausa: "Zafi/Sanyi", example: "The sun is hot. Ice is cold." },
              { adjective: "Fast", opposite: "Slow", emoji: "🏃", french: "Rapide/Lent", hausa: "Sauri/Jinkirin", example: "The car is fast. The turtle is slow." }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn prepositions - words that tell us where things are located.",
            prepositions: [
              { preposition: "In", emoji: "📦", french: "Dans", hausa: "A ciki", example: "The book is in the bag." },
              { preposition: "On", emoji: "📚", french: "Sur", hausa: "A kan", example: "The book is on the table." },
              { preposition: "Under", emoji: "⬇️", french: "Sous", hausa: "A ƙarƙashi", example: "The cat is under the chair." },
              { preposition: "Next to", emoji: "↔️", french: "À côté de", hausa: "Kusa da", example: "I sit next to my friend." }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/9', (req, res) => {
    res.json({
      id: 9,
      title: "Time & Questions",
      description: "Learn to tell time using o'clock and ask questions using who, what, where, when, why, and how.",
      lessons: [
        {
          id: 1,
          title: "Telling Time",
          content: {
            introduction: "Welcome to Module 9! Today we learn about time! We use o'clock to tell time.",
            times: [
              { time: "1 o'clock", emoji: "🕐", french: "1 heure", hausa: "Karfe daya", example: "I eat lunch at 1 o'clock." },
              { time: "3 o'clock", emoji: "🕒", french: "3 heures", hausa: "Karfe uku", example: "School ends at 3 o'clock." },
              { time: "6 o'clock", emoji: "🕕", french: "6 heures", hausa: "Karfe shida", example: "I wake up at 6 o'clock." },
              { time: "9 o'clock", emoji: "🕘", french: "9 heures", hausa: "Karfe tara", example: "I go to bed at 9 o'clock." }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn question words! These words help us ask for information.",
            questionWords: [
              { word: "What", emoji: "❓", french: "Qu'est-ce que", hausa: "Me", example: "What is your name?" },
              { word: "Where", emoji: "📍", french: "Où", hausa: "Ina", example: "Where do you live?" },
              { word: "When", emoji: "🕰️", french: "Quand", hausa: "Yaushe", example: "When do you go to school?" },
              { word: "Who", emoji: "👤", french: "Qui", hausa: "Wa", example: "Who is your teacher?" },
              { word: "Why", emoji: "🤔", french: "Pourquoi", hausa: "Me yasa", example: "Why do you study English?" },
              { word: "How", emoji: "🔧", french: "Comment", hausa: "Yaya", example: "How do you go to school?" }
            ]
          }
        }
      ]
  ...
  app.get('/api/modules/10', (req, res) => {
    res.json({
      id: 10,
      title: "Hobbies & Past Tense",
      description: "Learn about leisure activities and talk about things that happened yesterday using simple past tense.",
      lessons: [
        {
          id: 1,
          title: "Fun Activities",
          content: {
            introduction: "Welcome to Module 10! Today we learn about hobbies - fun things we like to do in our free time!",
            hobbies: [
              { hobby: "Reading", emoji: "📚", french: "Lire", hausa: "Karanta", example: "I like reading stories and books." },
              { hobby: "Drawing", emoji: "🎨", french: "Dessiner", hausa: "Zana", example: "I like drawing pictures and animals." },
              { hobby: "Singing", emoji: "🎵", french: "Chanter", hausa: "Waƙa", example: "I like singing songs with my friends." },
              { hobby: "Dancing", emoji: "💃", french: "Danser", hausa: "Rawa", example: "I like dancing to music." },
              { hobby: "Playing", emoji: "⚽", french: "Jouer", hausa: "Wasa", example: "I like playing football with my brother." }
            ]
          }
        },
        {
          ...
          content: {
            introduction: "Now let us learn about past tense - things that happened yesterday! We add -ed to most verbs.",
            pastTense: [
              { present: "Play", past: "Played", example: "Yesterday, I played football.", french: "Hier, j'ai joué au football", hausa: "Jiya, na buga kwallon kafa" },
              { present: "Walk", past: "Walked", example: "Yesterday, I walked to school.", french: "Hier, j'ai marché à l'école", hausa: "Jiya, na yi tafiya zuwa makaranta" },
              { present: "Help", past: "Helped", example: "Yesterday, I helped my mother.", french: "Hier, j'ai aidé ma mère", hausa: "Jiya, na taimaki mahaifiyata" },
              { present: "Watch", past: "Watched", example: "Yesterday, I watched a movie.", french: "Hier, j'ai regardé un film", hausa: "Jiya, na kalli fim" }
            ]
          }
        }
      ]
